# -*- coding: utf-8 -*-
"""
@Time    : 2023/12/25 20:11
@Author  : He Junfeng
@StudentID    : 2021113362
@File    : BC.py
"""
"""
This file is to calculate the BC
For simplicity's sake, we only choose one OD pair 1-20 to calculate the BC
"""
import numpy as np
class Node:
...
class Link:
    def __init__(self, link_id, tail_node, head_node, length=1):
